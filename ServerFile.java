 ...
 * and share text files between clients
 * 
 * 
...
public class ServerFile extends Thread {
	...
	public static void main(String args[]) throws IOException {
		...
		outUser1.writeObject("To Share File, type 'File', hit enter and give path of the file");
		outUser1.writeObject("****************************************************************");
		
		
		outUser2.writeObject("****************************************************************");
		outUser2.writeObject("Both User Connected. Start Now to Chat");
		outUser2.writeObject("To Share File, type 'File', hit enter and give path of the file");
		outUser2.writeObject("****************************************************************");
		outUser1.flush();
		outUser2.flush();
